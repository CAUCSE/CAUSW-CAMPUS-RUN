          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            ...
            <div className={styles.consents} aria-label="개인정보 동의">
              <details className={styles.disclosure}>
                ...
                <div>
                  <p>ICT 위원회는 CAU Campus Typing Game 운영을 위해 아래와 같이 개인정보를 수집·이용합니다.</p>
                  <p>수집·이용 목적: 게임 참여자 식별 및 중복 기록 관리, 리더보드 운영, 경품 추첨, 당첨 안내 및 경품 발송</p>
                  <p>수집 항목: 학번, 별명, 이메일 주소, 휴대전화번호, 게임 기록(완료 시간 및 오타 수)</p>
                  <p>보유·이용 기간: 경품 발송 완료 후 30일까지 보관한 뒤 지체 없이 파기</p>
                  <p>공개 항목: 리더보드에는 별명, 완료 시간 및 오타 수만 공개되며 학번과 연락처는 공개되지 않습니다.</p>
                  <p>귀하는 개인정보 수집·이용 동의를 거부할 권리가 있습니다. 다만 필수 정보 수집에 동의하지 않으면 게임 참여와 경품 추첨 대상 등록이 제한됩니다.</p>
                </div>
              </details>
              ...
              <details className={styles.disclosure}>
                ...
                <div>
                  <p>ICT 위원회는 모바일 경품 발송을 위해 아래와 같이 개인정보를 제공합니다.</p>
                  <p>제공받는 자: ㈜윈큐브마케팅(센드비)</p>
                  <p>제공 목적: 당첨자 모바일 쿠폰 발송 및 발송 관련 고객지원</p>
                  <p>제공 항목: 별명, 휴대전화번호</p>
                  <p>제공받는 자의 보유·이용 기간: 경품 발송 및 관련 고객지원 목적 달성 후 지체 없이 파기. 단, 관계 법령에 따라 보존할 의무가 있는 경우 해당 법정 기간 동안 보관</p>
                  <p>귀하는 개인정보 제공 동의를 거부할 권리가 있습니다. 다만 필수 제공에 동의하지 않으면 게임 참여와 경품 추첨 대상 등록이 제한됩니다.</p>
                </div>
              </details>
